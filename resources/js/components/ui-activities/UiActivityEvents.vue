    ...
    <div>
        <template v-if="subject">
            ...
            >
                ...
                >
                    <span
                        class="font-semibold leading-tight text-xl"
                        v-html="name"
                    />
                    ...
                    <p class="mb-1 mt-2">
                        ...
                        {{ dateFrom }},
                        {{ `${subject.from.hours}:${subject.from.minutes}` }} -
                        <span
                    ...
                    <p class="mb-1">
                        ...
                        <span v-html="subject.price === 0 ? '<i class=\'text-gray-500\'>kostenlos</i>' : `${subject.price} &euro;`" />
                    </p>
                </a>
            </ripple>
        </template>
